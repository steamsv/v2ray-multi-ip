...
# 下载新的配置文件
if ! curl -L https://raw.githubusercontent.com/steamsv/v2ray-multi-ip/main/socksconfig.json -o /usr/local/etc/v2ray/config.json; then
    echo "下载新的配置文件失败" >&2
    exit 1
fi
